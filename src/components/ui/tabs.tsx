...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-9 items-center justify-center rounded-full bg-primary-ghost p-1 text-primary-strong',
      className
    )}
    {...props}
  />
